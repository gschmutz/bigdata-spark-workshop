...
curl -XPOST -H "Content-Type:application/json" -d"{\"schema\":$SCHEMA}" http://127.0.0.1:8081/subjects/$TOPIC-value/versions
```
...
```bash
export TOPIC=topicName
http http://127.0.0.1:8081/subjects/$TOPIC-value/versions/latest \
