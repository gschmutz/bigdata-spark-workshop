...
Navigate to <http://127.0.0.1:7474> and login as user `neo4j` and password `abc123abc123`.
...
Navigate to <http://127.0.0.1:28888> and login with the token specified above, i.e. `abc123!`.
