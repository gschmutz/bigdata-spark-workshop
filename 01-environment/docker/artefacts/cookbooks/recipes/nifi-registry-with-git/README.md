...
Navigate to the NiFi Registry: <http://127.0.0.1:19090/nifi-registry> and create a new bucket and name it `my-bucket`.

![](./images/create-bucket.png)

Navigate to NiFi <https://127.0.0.1:18080> and login as user `nifi` with password `1234567890ACD`.
