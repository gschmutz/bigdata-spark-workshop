...
Navigate to AKHQ on <http://127.0.0.1:28107>.

## KaDeck

Navigate to KaDeck on <http://127.0.0.1:28313>, login as user `admin` with password `admin` and accept the license information.
