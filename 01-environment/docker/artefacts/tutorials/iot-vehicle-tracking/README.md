...
For a list of available services, navigate to <http://127.0.0.1:80/services>.

When a terminal is needed, you can use the Web Terminal available at <http://127.0.0.1:3001/>.
...
If you don't like to work with the CLI, you can also create the Kafka topics using the graphical user interfaces [Cluster Manager for Kafka (CMAK)](http://127.0.0.1:28104) or the [Apache Kafka HQ (AKHQ)](http://127.0.0.1:28107). 
...
To start consuming using the MQTT UI ([HiveMQ Web UI](https://www.hivemq.com/docs/3.4/web-ui/introduction.html)), navigate to <http://127.0.0.1:28136> and connect using `dataplatform` for the **Host** field, `9101` for the **Port** field and then click on **Connect**: 
...
Navigate to the [Kafka Connect UI](http://127.0.0.1:28103) to view the connector in a graphical window.
...
You can use the Schema Registry UI on <http://127.0.0.1:28102> to view the Avro Schema created by ksqlDB.
...
public class DetectProblematicDriving {
	...
	public static void main(final String[] args) {
		...
		final String schemaRegistryUrl = "http://127.0.0.1:8081";
