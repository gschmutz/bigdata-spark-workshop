...
Navigate to <http://127.0.0.1:28298> to view the Thriftserver UI.
...
Use `jdbc:hive2://127.0.0.1:28118` (external) or `jdbc:hive2://spark-thriftserver:10000` (internal) for the JDBC URL and use `org.apache.hive.jdbc.HiveDriver` for the class name. 
