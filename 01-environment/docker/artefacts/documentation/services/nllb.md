...
REST API documentation available [here](http://127.0.0.1:28257/api/schema/swagger).

Translate

```bash
curl 'http://127.0.0.1:28257/api/v4/translator?text=Hello&source=eng_Latn&target=spa_Latn'
```
