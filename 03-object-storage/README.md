...
In a browser window navigate to <http://dataplatform:38081> and you should see the Apache Zeppelin homepage. 
...
But here we will demonstrate it using Apache Zeppelin. In a browser window navigate to <http://dataplatform:38081> and open the **Spark Interpreter**. We have seen how to do that in the [Spark Workshop](../05-spark/README.md).
